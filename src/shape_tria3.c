...
*******************************************************************************
* DESCRIPTION                                                                 *
* Returns a vector N with the shape functions     2                           *
* for linear interpolation in a isoparametric     |\                          *
* triangular element (3-noded triangle).          |_\                         *
* Node order as in figure.                       3   1                        *
******************************************************************************/
