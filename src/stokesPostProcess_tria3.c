/******************************************************************************
* File      : stokesPostProcess_tria3.c                                       *
...
#include "stokesPostProcess_tria3.h"
                            ...
                            double *vB)
{
    ...
    switch(ANALYSIS){
        case 0:
            fprintf(file_log,"\n\tstokesPostProcess_tria3():");
            fprintf(file_log," doing velocity field calculation ...");
	...
	for(i = 0; i < nInternalPoints; i++){
        ...
        switch(ANALYSIS){
            case 0:	
                velocity_tria3(Xin,mNodes,mElems,vProbParam,vB,U);
                fprintf(fv,"%le\t%le\t%le\t",Xin[0],Xin[1],Xin[2]);
                fprintf(fv,"%le\t%le\t%le\n",U[0],U[1],U[2]);
                break;
            case 1:
                P = pressure_tria3(Xin,mNodes,mElems,vB);
