...
{
    const unsigned int NODES_IN_ELEM = 6, SIZE = 3*nNodes;
    ...
    for(i = 0; i < nNodes; i++){
        ...
        for(j = 0; j < nElems; j++){
            ...
            if(SinNode == 0) intGStk_tria6(X,Xeval,INT);
            else intSingularGStk_tria6(SinNode,X,Xeval,INT);
